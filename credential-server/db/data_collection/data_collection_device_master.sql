...
CREATE TABLE `device_master` (
  ...
  `hardware_id` bigint DEFAULT NULL,
  ...
  KEY `sim_id` (`sim_id`),
  CONSTRAINT `device_master_ibfk_1` FOREIGN KEY (`hardware_id`) REFERENCES `hardware_info` (`hardware_id`),
  CONSTRAINT `device_master_ibfk_2` FOREIGN KEY (`software_id`) REFERENCES `software_info` (`software_id`),
  CONSTRAINT `device_master_ibfk_3` FOREIGN KEY (`sim_id`) REFERENCES `sim_info` (`sim_id`)
